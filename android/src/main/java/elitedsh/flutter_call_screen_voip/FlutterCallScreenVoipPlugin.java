...
public class FlutterCallScreenVoipPlugin implements MethodCallHandler {
  ...
  private void registerPhoneAccount(String nameApp) {
    ...
    PhoneAccount phoneAccount = PhoneAccount.builder(phoneAccountHandle, nameApp + " App")
        .setShortDescription(nameApp + " Asesores").addSupportedUriScheme(PhoneAccount.SCHEME_TEL)
        .setSupportedUriSchemes(Arrays.asList("tel")).setCapabilities(PhoneAccount.CAPABILITY_CALL_PROVIDER)
  ...
  public void goToScreenSttingPhone() {
    if (Build.MANUFACTURER.equalsIgnoreCase("Samsung")) {
      ...
      activity.startActivity(new Intent(TelecomManager.ACTION_CHANGE_PHONE_ACCOUNTS));
